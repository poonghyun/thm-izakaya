...
export const dishToIncompatible = {
...
export const customerToIncompatible = {
  'rabbit': [],
  'cat': [],
  'tanuki': [],
  'fox': [],
...
export function tagsForCustomer(customer) {
...
export function ingredientsForOneTagDishes(customer, dish) {
